...
public class TestCosmosDB {
    ...
    public void testLoad() throws Exception {
        ...
        try {
            CosmosPagedIterable<Count> response = db.customerContainer.queryItems(sql, new CosmosQueryRequestOptions(), Count.class);
        ...
        try {
            CosmosPagedIterable<Count> response = db.ordersContainer.queryItems(sql, new CosmosQueryRequestOptions(), Count.class);
            if (response.iterator().hasNext()) {
                Count customer = response.iterator().next();
